...
file_object = open("/home/pi/Scripts/temp.txt", "a")
...
file_object.write("Temperature in Celsius : %.2f C \n" %cTemp)
file_object.write("Temperature in Fahrenheit : %.2f F \n" %fTemp)
file_object.write("Pressure : %.2f hPa \n" %pressure)
